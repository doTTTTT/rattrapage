// Generated on 2017-07-19 using generator-angular-fullstack 4.2.2
'use strict';
...
gulp.task('start:server:prod', () => {
    ...
    pm2.connect(function(err) {
        ...
        pm2.start({
            name: 'prod_friends',
            script: `${paths.dist}/${serverPath}/index.js`,
            force: true, //used to start prod / pprod / dev in the same time
            env: config,
            max_memory_restart: '1G'
        }, function(err, apps) {
            console.log('pm2 started prod env');
            if (err) throw err;
        });
    });
